...
# bgSound.load("E:/dev/python_workspace/sounds/nabi.mp3")
# bgSound.set_volume(0.2)
# bgSound.play()

# fireSound = pygame.mixer.Sound("E:/dev/python_workspace/sounds/fire3.mp3")
...
while isRunning :
    ...
    # 적 우주선 객체 생성 
    if cnt % 20 == 0 and isGameOver == False: 
        makeEnemy()
